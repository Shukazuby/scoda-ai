  ...
  return (
    <div className="w-full max-w-full space-y-5">
      <form onSubmit={handleSubmit} className="relative w-full" aria-label="Generate content ideas">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 bg-gray-900/60 border border-primary-500/40 rounded-2xl sm:rounded-full px-4 py-6 md:py-6 lg:px-6 lg:py-3 lg:min-h-[3.25rem] shadow-lg shadow-primary-950/20 backdrop-blur-md overflow-hidden min-h-[8rem] md:min-h-[9rem] w-full max-w-full lg:max-w-4xl lg:mx-auto lg:justify-center">
          <div className="flex items-center gap-3 flex-1 min-w-0 w-full min-h-[5rem] md:min-h-[6rem] lg:min-h-10 lg:flex-initial lg:min-w-[16rem]">
            ...
            <textarea
              ...
              className="flex-1 min-w-0 w-full bg-transparent text-white placeholder-gray-500 outline-none text-[15px] sm:text-base resize-none min-h-[5rem] md:min-h-[6rem] lg:min-h-10 lg:py-0 lg:leading-10 max-h-56 py-2 break-words leading-relaxed"
              disabled={loading}
      ...
      {suggestedTopics.length > 0 && (
        <div className="space-y-2 flex flex-col items-center">
          <p className="text-xs font-medium uppercase tracking-wider text-gray-500 text-center">Try a suggestion</p>
